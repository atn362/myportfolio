    ...
    toggleCategories() {
        ...
        if(this.state.activeTab === 0){
            return(
                ...
                <CardActions border>
                    <Button href="https://github.com/atn362/quiz-homework.git" target="_blank" colored>GitHub</Button>
                    <Button href="https://atn362.github.io/quiz-homework//" target="_blank" colored>Deployed Url</Button>
                </CardActions>
            ...
            <Card shadow={5} style={{minWidth: '450',  margin: 'auto'}}>
                ...
                <CardActions border>
                    <Button href="https://github.com/atn362/updated-portfolio.git" target="_blank" colored>GitHub</Button>
                    <Button href="https://atn362.github.io/updated-portfolio/" target="_blank" colored>Deployed Url</Button>
                </CardActions>
                <CardMenu style={{color: '#fff'}}>
                    <IconButton name="share" />
                </CardMenu>
            ...
            return (
                ...
                <CardActions border>
                    <Button href="https://github.com/atn362/weather_app.git" target="_blank" colored>GitHub</Button>
                    <Button href="https://atn362.github.io/weather_app/" target="_blank" colored>Deployed Url</Button>
                </CardActions>
                <CardMenu style={{color: '#fff'}}>
                    <IconButton name="share" />
                </CardMenu>
             ...
             <Card shadow={5} style={{minWidth: '450',  margin: 'auto'}}>
                ...
                <CardActions border>
                    <Button href="https://github.com/atn362/password-generator.git" target="_blank" colored>GitHub</Button>
                    <Button href="https://atn362.github.io/password-generator/" target="_blank" colored>Deployed Url</Button>
                </CardActions>
                <CardMenu style={{color: '#fff'}}>
                    <IconButton name="share" />
                </CardMenu>
            ...
            return(
                ...
                <CardActions border>
                    <Button href="https://github.com/atn362/express-note-taker.git" target="_blank" colored>GitHub</Button>
                    <Button href="https://mysterious-escarpment-41652.herokuapp.com/" target="_blank" colored>Deployed Url</Button>
                </CardActions>
                <CardMenu style={{color: '#fff'}}>
                    <IconButton name="share" />
                </CardMenu>
        ...
        <CardActions border>
            <Button href="https://github.com/atn362/Musical-Musings.git" target="_blank" colored>GitHub</Button>
            <Button href="https://intense-dusk-91957.herokuapp.com/" target="_blank" colored>Deployed Url</Button>
        </CardActions>
        <CardMenu style={{color: '#fff'}}>
            <IconButton name="share" />
        </CardMenu>
